...
![Multirepo to Monorepo](./figures/02-multi-to-mono.png){ width=70% }
...
-   **Visibility**: everyone can see everyone else’s code, leading to better collaboration and cross-team contributions. Any developer can fix a bug in your code before you even noticed it.
...
-   **Learning curve**: the learning curve for new developers is steeper if the repository spans many tightly-coupled projects. Keep in mind that the same thing can happen with multi-repos.
...
A monorepo, on the other hand, works as a central hub, a market square of sorts where every developer, engineer, tester, and business analyst meet and talk. Monorepos encourage conversations while helping bring silos down.
